...
function KakaoLogin({wide=false}) {
    ...
    const redirect_uri = `https://${import.meta.env.VITE_API_HOST}:${import.meta.env.VITE_API_PORT}/auth/kakao/callback`; // Backend endpoint for handling Kakao's response
